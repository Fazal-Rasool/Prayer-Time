...
public class ToolTipView extends LinearLayout implements
	...
	private void applyToolTipPosition() {
		...
		float toolTipViewX = Math
				.max(0, relativeMasterViewCenterX - mWidth / 2);
		...
		if (mToolTip.getAnimationType() == ToolTip.ANIMATIONTYPE_FROMMASTERVIEW) {
			animators.add(ObjectAnimator.ofFloat(this, "translationY",
					mRelativeMasterViewY + mView.getHeight() / 2 - getHeight()
							/ 2, toolTipViewY));
			animators.add(ObjectAnimator.ofFloat(this, "translationX",
					mRelativeMasterViewX + mView.getWidth() / 2 - mWidth / 2,
					toolTipViewX));
		} else if (mToolTip.getAnimationType() == ToolTip.ANIMATIONTYPE_FROMTOP) {
			animators.add(ObjectAnimator.ofFloat(this, "translationY", 0,
					toolTipViewY));
		}
	...
	public void setOnToolTipViewClickedListener(
			OnToolTipViewClickedListener listener) {
		mListener = listener;
	}
	...
	public void remove() {
		...
		List<Animator> animators = new ArrayList<Animator>();
		if (mToolTip.getAnimationType() == ToolTip.ANIMATIONTYPE_FROMMASTERVIEW) {
			animators.add(ObjectAnimator.ofFloat(this, "translationY", getY(),
					mRelativeMasterViewY + mView.getHeight() / 2 - getHeight()
							/ 2));
			animators.add(ObjectAnimator.ofFloat(this, "translationX", getX(),
					mRelativeMasterViewX + mView.getWidth() / 2 - mWidth / 2));
		} else {
			animators.add(ObjectAnimator.ofFloat(this, "translationY", getY(),
					0));
